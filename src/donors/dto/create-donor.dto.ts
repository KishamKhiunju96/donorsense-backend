...
export class CreateDonorDto {
  ...
  @ApiPropertyOptional({ description: 'Tags assigned to the donor', type: [String] })
  @IsOptional() @IsArray()
  tags?: string[];
  ...
  @ApiPropertyOptional({ description: 'Whether the donor wants to remain anonymous', default: false })
